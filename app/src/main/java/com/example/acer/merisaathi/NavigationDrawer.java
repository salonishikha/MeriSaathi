...
public class NavigationDrawer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b3=(Button) findViewById(R.id.Navigation_b3);
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(NavigationDrawer.this,Discussion_forum.class);
                startActivity(intent);
            }
        });
        Button b4=(Button) findViewById(R.id.Navigation_b4);
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(NavigationDrawer.this,Online_Quiz.class);
                startActivity(intent);
            }
        });
